    ...
    $input.on("focus", function () {
      $input.autocomplete({
        open: function (e) {
          ...
          if (close.length === 0) {
            close = $('<li class="ui-menu-item mse2-ac-close"></li>').appendTo(menu);
          ...
          menu.append(`<li class="ui-menu-item mse2-ac-more"><a href="/search?query=${$input.val()}">Показать все</a></li>`);
        },
      });
